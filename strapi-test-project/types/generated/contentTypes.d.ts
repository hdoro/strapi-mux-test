...
export interface ApiVideoBlogPostVideoBlogPost extends Schema.CollectionType {
  collectionName: 'video_blog_posts';
  info: {
    singularName: 'video-blog-post';
    pluralName: 'video-blog-posts';
    displayName: 'Video blog post';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    author: Attribute.Relation<
      'api::video-blog-post.video-blog-post',
      'oneToOne',
      'admin::user'
    >;
    asset_info: Attribute.JSON;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::video-blog-post.video-blog-post': ApiVideoBlogPostVideoBlogPost;
